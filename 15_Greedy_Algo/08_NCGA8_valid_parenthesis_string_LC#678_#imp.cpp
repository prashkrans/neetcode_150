/*
LC#678. NCGA8. Valid Parenthesis String
...
// 1. Use two stacks to track the indices of left parentheses and '*' characters. (Prefer this method since its easy to understand)
// Time Complexity: O(n), where n is the length of the string | 0ms beats 100%
